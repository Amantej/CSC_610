...
x_train = pd.read_csv('../data/csvfile/assign2/non-overlap_Merged_image0image1_train.csv',header=None)[1:]
x_test = pd.read_csv('../data/csvfile/assign2/non-overlap_Merged_image0image1_test.csv',header=None)[1:]
...
pd.DataFrame(CC).to_csv('../data/csvfile/assign2/lassocc2class.csv', index = False)
TN = CC[1,1]
FP = CC[1,0]
FN = CC[0,1]
TP = CC[0,0]
